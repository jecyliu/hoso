...
class TableTableViewController: UIViewController {
    ...
    let emojiMessage = [
        "vSad": ["The sun will eventually come out.☀️", "Keep going it will get better.🙌", "Leaders never use the word failure. They look upon setbacks as learning experiences.🤓", "Life is too short to live the same day twice.🛣", "You become stronger when you fall.💪", "Keep looking up, that's the secret of life.🚀", "Only you can change your life.🌻"],
